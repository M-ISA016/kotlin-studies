fun main() { // SITE: kotlintutorial.io
    val vehicle1: Vehicle = Vehicle() // Here, an object of type 'Vehicle' is created and assigned to the variable 'vehicle1'

    vehicle1.make = "Toyota"   // Sets the make of the 'vehicle1' object to 'Toyota'
    vehicle1.model = "Corolla" // Assigns the model of the 'vehicle1' object as 'Corolla'
    vehicle1.color = "blue"    // Changes the color of the 'vehicle1' object to 'blue'
    vehicle1.engineSize = 1.9f // Updates the engine size of the 'vehicle1' object to '1.9'
